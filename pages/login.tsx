...
export default function Signup() {
  ...
  return (
    <Container>
      ...
      <RightContainer>
        <Typography color="#111927" fontSize="36px" fontWeight={600} style={{marginBottom: 20}}>Log in</Typography>
        <Box style={{margin: "30px 0"}}>
          <IconButton width={24} height={24} style={{flex: 1, border: "1px solid #D2D6DB", marginRight: 10}} icon="/icons/google-only.png" />
        ...
        <Box flexDirection="column" alignItem="flex-start">
          ...
          <Box style={{width: '100%', marginBottom: 30}}>
            <Button color="#4B48EC" fontColor="white" fullWidth style={{height: 40}} >Log in</Button>
          </Box>
        </Box>
      </RightContainer>
    </Container>
