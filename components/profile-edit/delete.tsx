...
export default function Delete({ open, setOpen }) {
  return (
    <Modal open={open} closeButton handleClose={() => setOpen(false)} width="auto">
      ...
      <Typography fontSize="18px" fontWeight={600} color="#111927">Delete</Typography>
      <Typography color="#4D5761" fontSize="14px" style={{marginTop: 5, width: 320}}>Are you sure you want to delete this expererience? This action cannot be undone.</Typography>
